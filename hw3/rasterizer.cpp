...
{   
    ...
    float sing = (_v[1].x()-_v[0].x())*(_v[2].y()-_v[0].y())-(_v[1].y()-_v[0].y())*(_v[2].x()-_v[0].x());
    float singAB = (_v[1].x()-_v[0].x())*(y-_v[0].y())-(_v[1].y()-_v[0].y())*(x-_v[0].x());
    float singCA = (_v[0].x()-_v[2].x())*(y-_v[2].y())-(_v[0].y()-_v[2].y())*(x-_v[2].x());
    float singBC = (_v[2].x()-_v[1].x())*(y-_v[2].y())-(_v[2].y()-_v[1].y())*(x-_v[2].x());

    bool d1 = (singAB*sing > 0);
    bool d2 = (singCA*sing > 0);
    bool d3 = (singBC*sing > 0);
